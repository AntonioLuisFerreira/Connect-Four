...
from j4_em_linha_motor_47500 import novo_jogo
from j4_em_linha_motor_47500 import ha_espaco
from j4_em_linha_motor_47500 import jogar
from j4_em_linha_motor_47500 import valor
from j4_em_linha_motor_47500 import terminou
from j4_em_linha_motor_47500 import quem_ganhou
from j4_em_linha_motor_47500 import get_linha_vitoria
from j4_em_linha_motor_47500 import proximo_a_jogar

from j4_em_linha_agente_47500 import jogada_agente
...
def print_jogo(jogo):
    ...
    for l in range(6):
        linha_str = ''
        for c in range(7):
            linha_str = linha_str + str(valor(jogo, l+1, c+1)) + ' '
        print(linha_str)
...
def print_jogo_vitoria(jogo, linha_vitoria):
    ...
    for l in range(6):
        linha_str = ''
        for c in range(7):
            if [l+1, c+1] in linha_vitoria:
                valor_string = '*'
            else:
                valor_string = str(valor(jogo, l+1, c+1))
